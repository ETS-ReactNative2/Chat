 ...
 * On mobile devices, your app can be added directly to the user's home screen, app icon and all. You can also re-engage users using web **push notifications**. This eliminates the need for the app _store.
...
1. _users aren't always familiar with offline-first web apps. It can be useful to
